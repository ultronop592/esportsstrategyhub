    ...
    <div className="container mx-auto px-4 pt-28 pb-16">
      ...
      <div className="text-center mb-28 relative">
        ...
        <div className="space-y-10">
          <h1 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary via-primary/90 to-primary/80 leading-loose pb-4 mb-2 h-auto">
